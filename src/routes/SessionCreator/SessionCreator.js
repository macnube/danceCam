...
class SessionCreator extends React.Component {
    ...
    setSegmentTime = () => {
        if (!this.state.player) {
            return this.setState({
                error:
                    "Can't create a segment yet, YouTube Player is not loaded",
            });
        }
    ...
    render() {
        ...
        return (
            <div>
                ...
                <input
                    value={videoId}
                    onChange={this.setInputState('videoId')}
                />
                <br />
                <YouTubePlayer
                    videoId={videoId}
                ...
                <button
                    ref={el => (this.setSegmentTimeButton = el)}
                    onClick={this.setSegmentTime}
                >
                    {segmentStart ? 'Stop segment' : 'Start segment'}
                </button>
                <h2>Edit segments</h2>
                ...
                >
                    <form onSubmit={this.closeModal}>
                        ...
                        <input
                            autoFocus
                            value={segmentName}
                            onChange={this.setInputState('segmentName')}
                        />
